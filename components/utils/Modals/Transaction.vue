  ...
  <div class="modal__bg">
    <div class="modal__container" v-click-outside="closeModal">
      ...
      <div class="modal__body">
        <div
          class="w-100 mb-8 p-6 flex flex-col justify-center items-center bg-brand-accent"
        >
          <h2>{{ formatPrice(4200) }}</h2>
        ...
        <div class="my-6 pl-14 flex items-center">
            <Icon class="mr-2" variant="card" :size="20"/> 2940 <h3 class="mx-2">•</h3> <b>{{formatPrice(1552.88)}}</b>
        </div>
      <hr class="my-8" />
      <h4 class="mb-3">Comment</h4>
      <h3 class="mb-8">Booking a hotel in New York for me and my colleague for a week. Work trop on 08.19.2021.</h3>
      </div>
      <div class="modal__footer">
        <utils-button dark>Accept</utils-button>
        <utils-button>Decline</utils-button>
      </div>
    </div>
  </div>
</template>
